 ...
 <div class="home_container">
   <div class="container mt-5">
    ...
    <section class="text-center mt-5">
        ...
        <a href="<?php echo e(url('/contact')); ?>" class="btn btn-primary mt-3">Liên hệ với chúng tôi</a>
    </section>
</div>
 </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('footer' , $viewData['footer']); ?>
<?php echo $__env->make('layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\DoAnCuoiKy_Website\Laptop-Store\Laptop-Store\Laptop_Store\resources\views/home/about.blade.php ENDPATH**/ ?>