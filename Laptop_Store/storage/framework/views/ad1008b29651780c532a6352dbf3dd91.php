        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
               <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link hover_link_login <?php echo e(request()->is('login') ? 'active' : ''); ?>"
                        href="<?php echo e(url('/login')); ?>"><i class="fa-solid fa-user me-1"></i> Login</a>
                    </li>
                </ul>
            </div>
        </div>
...
</html><?php /**PATH F:\DoAnCuoiKy_Website\Laptop-Store\Laptop-Store\Laptop_Store\resources\views/layouts/index.blade.php ENDPATH**/ ?>