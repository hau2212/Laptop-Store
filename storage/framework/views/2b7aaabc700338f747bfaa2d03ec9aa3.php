...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'My Website'); ?></title><!-- Tiêu đề mặc định, cho phép override -->
    ...
    <?php echo $__env->yieldContent('style'); ?><!-- Cho phép chèn thêm CSS riêng của từng view -->
</head>
    <?php
    ...
    ?>
<body class="d-flex flex-column min-vh-100 background <?php echo e($hideSidebar ? 'no-sidebar' : ''); ?>"><!-- Dàn trang full-height; thêm class no-sidebar khi cần -->
            ...
            <div class="flex-grow-1 mx-3">
                <form action="<?php echo e(route('products.search')); ?>" method="GET" class="d-flex">
                    <input 
                        ...
                        value="<?php echo e(request('query')); ?>"> <!-- Giữ lại từ khoá khi reload -->
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link hover_link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>"
                           href="<?php echo e(route('home.main')); ?>">Home</a><!-- Active khi ở route home -->
                    </li>
                    <li class="nav-item">
    ...
    <!-- ===== MAIN CONTENT ===== -->
    <?php echo $__env->yieldContent('sidebar'); ?><!-- Hook nếu trang con muốn tự render sidebar riêng -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class='col-md-5col-lg-10 px-4'>
                    <?php echo $__env->yieldContent('content'); ?><!-- Nội dung động của từng trang -->
                </div>
            </div>
        </div>
    </main>
            ...
            <div class="footer-inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-start text-center">
                        ...
                        <p class="mb-0">
                            <?php echo $__env->yieldContent('footer', '© 2024 My Website. All rights reserved.'); ?><!-- Cho phép override dòng bản quyền -->
                        </p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Doan\Laptop-Store\resources\views/layouts/app.blade.php ENDPATH**/ ?>